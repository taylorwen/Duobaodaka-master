...
@interface SettingServiceVC ()<UIWebViewDelegate, NJKWebViewProgressDelegate>
{
    UIWebView       *_webView;
...
-(void)loadGoogle
{
    NSURLRequest *req = [[NSURLRequest alloc] initWithURL:[NSURL URLWithString:oyServiceList]];
