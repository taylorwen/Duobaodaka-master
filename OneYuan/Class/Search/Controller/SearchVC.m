...
- (void)viewDidLoad
{
    ...
    vSearch.backgroundColor = mainColor;
...
//        AllProList* list = [[AllProList alloc] initWithDictionary:(NSDictionary*)result error:NULL];
//        arrData = list.Rows;
//        [tbView reloadData];
//        if(arrData.count == 0)
//        {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString* goodsId = [[arrData objectAtIndex:indexPath.row] goodsID];
