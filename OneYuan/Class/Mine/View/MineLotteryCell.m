...
//  MasterDuoBao
//
//  Created by zhan wen on 15/7/9.
//  Copyright (c) 2015年 wenzhan. All rights reserved.
//

#import "MineLotteryCell.h"

@interface MineLotteryCell ()
{
    UIImageView     *imgPro;
    UILabel         *lblTitle;
    UILabel         *lblAllneed;
...
@end
@implementation MineLotteryCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        lblAllneed = [[UILabel alloc]initWithFrame:CGRectMake(110, 55, mainWidth-120, 15)];
        lblAllneed.textColor = [UIColor lightGrayColor];
        lblAllneed.font = [UIFont systemFontOfSize:11];
        [self addSubview:lblAllneed];
        
        UILabel* lbl1 = [[UILabel alloc] initWithFrame:CGRectMake(110, 75, 100, 15)];
        lbl1.text = @"您已参与";
        lbl1.textColor = [UIColor lightGrayColor];
        lbl1.font = [UIFont systemFontOfSize:11];
        [self addSubview:lbl1];
        
        lblNum = [[UILabel alloc] initWithFrame:CGRectMake(160, 75, 100, 15)];
        ...
        btnLottery = [[UILabel alloc] initWithFrame:CGRectMake(110, 95, 200, 15)];
        btnLottery.text = @"正在揭晓中，请稍后...";
        btnLottery.textColor = mainColor;
        btnLottery.font = [UIFont systemFontOfSize:11];
...
- (void)setLottery:(MineMyBuyItem*)item
{
    ...
    lblAllneed.text = [NSString stringWithFormat:@"总需人数：%@ 人次",item.zongrenshu];
    ...
    lblRC.frame = CGRectMake(160 + s.width + 5, 75, 100, 15);
}
@end
