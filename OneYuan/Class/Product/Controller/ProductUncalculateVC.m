//
//  ProductUncalculateVC.m
//  MasterDuoBao
//
//  Created by zhan wen on 15/7/8.
//  Copyright (c) 2015年 wenzhan. All rights reserved.
//

#import "ProductUncalculateVC.h"

@interface ProductUncalculateVC ()<UIWebViewDelegate, NJKWebViewProgressDelegate>
{
    UIWebView       *_webView;
...
@implementation ProductUncalculateVC
...
-(void)loadGoogle
{
    NSURLRequest *req = [[NSURLRequest alloc] initWithURL:[NSURL URLWithString:oyGetunCalculate]];
