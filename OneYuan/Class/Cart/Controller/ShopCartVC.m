...
//  MasterDuoBao
//
//  Created by zhan wen on 15/7/20.
...
@interface ShopCartVC ()<UITableViewDataSource,UITableViewDelegate,CartCellDelegate,CartOptViewDelegate,ShopCartEmptyViewDelegate>
{
    __block ShopCartEmptyView   *viewEmpty;
...
- (void)viewDidLoad {
    ...
    viewEmpty = [[ShopCartEmptyView alloc] initWithFrame:self.view.bounds];
    [viewEmpty setDelegate:self];
    [viewEmpty setShopEmpty];
    
    viewOpt = [[CartOptView alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height - 106, mainWidth, 44)];
