...
@interface LotteryBuyRecordCell ()
{
    __weak id<LotteryBuyRecordCellDelegate> delegate;
    UIImageView* imgHead;
    UILabel*     lblName;
    UIButton*       btnName;
    UILabel*     lblArea;
...
@implementation LotteryBuyRecordCell
@synthesize delegate;
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self)
    {
        ...
        [btnName addTarget:self action:@selector(tapUserName) forControlEvents:UIControlEventTouchUpInside];
...
{
    if (delegate) {
        [delegate tapLotteryUsername:myItem.uid];
    }
}
@end
