...
- (void)addInfiniteScrollingWithActionHandler:(void (^)(void))actionHandler {
    ...
    if(!self.infiniteScrollingView) {
        SVInfiniteScrollingView *view = [[SVInfiniteScrollingView alloc] initWithFrame:CGRectMake(0, self.contentSize.height+64, self.bounds.size.width, SVInfiniteScrollingViewHeight)];
...
- (void)setShowsInfiniteScrolling:(BOOL)showsInfiniteScrolling {
    ...
    if(!showsInfiniteScrolling) {
      ...
      if (!self.infiniteScrollingView.isObserving) {
        ...
        self.infiniteScrollingView.frame = CGRectMake(0, self.contentSize.height+64, self.infiniteScrollingView.bounds.size.width, SVInfiniteScrollingViewHeight);
      }
    }
}
